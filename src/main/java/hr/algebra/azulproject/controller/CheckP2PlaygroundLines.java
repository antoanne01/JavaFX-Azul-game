...
import hr.algebra.azulproject.controller.SetStorageWall;
...
public class CheckP2PlaygroundLines {
    public static void checkFirstPlaygroundLines(List<Node> playgrounds, List<Node> storages, Map<String, String> checkStorage,Map<String, String> playgroundColorsForSerialization) {
        try{
            ...
            for (Node playground : playgrounds) {
                if (playground.getId().contains("pTwoGround204")) {
                    ...
                    try{
                        ...
                        System.out.println("Error processing pTwoGround204: " + e.getMessage());
                        continue;
                    }
                }
            }
    ...
    public static void checkSecondPlaygroundLines(List<Node> playgrounds, List<Node> storages, Map<String, String> checkStorage,Map<String, String> playgroundColorsForSerialization) {
        boolean foundPlayground = false;
        for (Node playground : playgrounds) {
            if (playground.getId().contains("pTwoGround214") || playground.getId().contains("pTwoGround213")) {
                ...
                try{
                    ...
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround213")) {
                            pGround13 = p;
                            color13 = p.getStyle();
                    ...
                    if (imagePath13 != null && imagePath13.equalsIgnoreCase(imagePath14)) {
                        for (Node storage : storages) {
                            if (storage.getId().equalsIgnoreCase(pane14)) {
                                ...
                                int startIndex = id.indexOf("pTwoGround2");
                    ...
                    System.out.println("Error processing pTwoGround214, pTwoGround213: " + e.getMessage());
                    continue;
                }
            }
        }
    ...
    public static void checkThirdPlaygroundLines(List<Node> playgrounds, List<Node> storages, Map<String, String> checkStorage,Map<String, String> playgroundColorsForSerialization) {
        ...
        boolean foundPlayground = false;
        for (Node playground : playgrounds) {
            if (playground.getId().contains("pTwoGround224") || playground.getId().contains("pTwoGround223")
                    || playground.getId().contains("pTwoGround222")) {
                ...
                try{
                    ...
                    Node pGround23 = null;
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround223")) {
                            pGround23 = p;
                            color23 = p.getStyle();
                    ...
                    Node pGround22 = null;
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround222")) {
                            pGround22 = p;
                            color22 = p.getStyle();
                    ...
                    if (imagePath23 != null && imagePath23.equalsIgnoreCase(imagePath24)
                        ...
                        for (Node storage : storages) {
                            if (storage.getId().equalsIgnoreCase(pane24)) {
                                ...
                                int startIndex23 = id23.indexOf("pTwoGround2");
                                String playgroundName23 = id23.substring(startIndex23);

                                String id22 = pGround22.getId();
                                int startIndex22 = id22.indexOf("pTwoGround2");
                    ...
                    System.out.println("Error processing pTwoGround224, pTwoGround223, pTwoGround222: " + e.getMessage());
                    continue;
                }
            }
        }
    ...
    public static void checkFourthPlaygroundLines(List<Node> playgrounds, List<Node> storages, Map<String, String> checkStorage,Map<String, String> playgroundColorsForSerialization) {
        ...
        for (Node playground : playgrounds) {
            if (playground.getId().contains("pTwoGround234") || playground.getId().contains("pTwoGround233")
                    || playground.getId().contains("pTwoGround232") || playground.getId().contains("pTwoGround231")) {
                ...
                try{
                    ...
                    Node pGround33 = null;
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround233")) {
                            pGround33 = p;
                            color33 = p.getStyle();
                    ...
                    Node pGround32 = null;
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround232")) {
                            pGround32 = p;
                            color32 = p.getStyle();
                    ...
                    Node pGround31 = null;
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround231")) {
                            pGround31 = p;
                            color31 = p.getStyle();
                    ...
                    if (imagePath34.equalsIgnoreCase(imagePath33)
                            && imagePath32.equalsIgnoreCase(imagePath34) && imagePath31.equalsIgnoreCase(imagePath34)) {
                        for (Node storage : storages) {
                    ...
                    System.out.println("Error processing pTwoGround234, pTwoGround233, " +
                            "pTwoGround232, pTwoGround231: " + e.getMessage());
                    continue;
                }
            }
        }
    ...
    public static void checkFifthPlaygroundLines(List<Node> playgrounds, List<Node> storages, Map<String, String> checkStorage,Map<String, String> playgroundColorsForSerialization) {
        ...
        for (Node playground : playgrounds) {
            if (playground.getId().contains("pTwoGround244") || playground.getId().contains("pTwoGround243")
                    || playground.getId().contains("pTwoGround242") || playground.getId().contains("pTwoGround241") ||
                    playground.getId().contains("pTwoGround240")) {
                ...
                try{
                    ...
                    Node pGround43 = null;
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround243")) {
                            pGround43 = p;
                            color43 = p.getStyle();
                    ...
                    Node pGround42 = null;
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround242")) {
                            pGround42 = p;
                            color42 = p.getStyle();
                    ...
                    Node pGround41 = null;
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround241")) {
                            pGround41 = p;
                            color41 = p.getStyle();
                    ...
                    Node pGround40 = null;
                    for (Node p : playgrounds) {
                        if (p.getId().contains("pTwoGround240")) {
                            pGround40 = p;
                            color40 = p.getStyle();
                    ...
                    System.out.println("Error processing pTwoGround244, pTwoGround243," +
                            "pTwoGround242, pTwoGround241, pTwoGround240: " + e.getMessage());
                    continue;
                }
            }
        }
